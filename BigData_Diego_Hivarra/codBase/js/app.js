var calculadora = {
	...
	asignarEventosFormatoBotones: function(selector)
  {
		...
		for (var i = 0; i<x.length;i++) {
			...
			x[i].onmouseleave = this.eventoTamanoOriginalBoton;
		};
	},
	...
	eventoDisminuyeBoton: function(event)
  {
	...
	eventoTamanoOriginalBoton: function(event)
  {
		calculadora.TamanoOriginalBoton(event.target);
	},
	...
	DisminuyeBoton: function(elemento)
  {
	...
	TamanoOriginalBoton: function(elemento)
  {
		var x = elemento.id;
		if (x=="1" || x=="2" || x=="3" || x=="0" || x=="igual" || x=="punto" ) {
